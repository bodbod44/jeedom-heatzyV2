...
?>
 ...
 <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
   ...
   <div class="eqLogicThumbnailContainer">
	  ...
	  <div class="cursor expertModeVisible" id="bt_groups" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 150px;margin-left : 10px;display:<?php if(log::getLogLevel('heatzy') == 100 || true ) echo 'display' ; else echo 'none' ; ?>" >
	    <center>
	        <i class="fa fa-object-group" style="font-size : 4em;color:#767676;"></i>
	    </center>
	    <span style="font-size : 1.1em;position:relative; top : 15px;word-break: normal;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Goupes de modules}}</center></span>
	  </div>
