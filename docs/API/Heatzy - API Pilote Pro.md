...
# Heatzy Pilote Pro : Description des points de données

Ce document présente l’ensemble des points de données accessibles via les API du module Heatzy Pilote Pro.
...
| Parameter | Type | Écriture | Description |
| :---- | :---- | :---- | :---- |
| mode | Enum (0-5) | écriture | Modes de chauffe. (en mode manuel) 0 : confort 1 : éco 2 : hors-gel 3 : arrêt 4 : confort-1 5 : confort-2 |
| cur\_mode | Enum (0-5) | lecture seule | Modes de chauffe actuel. 0 : confort 1 : éco 2 : hors-gel 3 : arrêt 4 : confort-1 5 : confort-2 |
| heating\_state | Bool (0-1) | lecture seule | Indique si la température cible a été atteinte. |
| cur\_signal | Enum (0-5) | lecture seule | Commande fil pilote actuellement envoyée au radiateur. (selon l’algorithme de gestion de température du Pilote Pro) 0 : confort 1 : éco 2 : hors-gel 3 : arrêt 4 : confort-1 5 : confort-2 |
| timer\_switch | Bool (0-1) | écriture | Activation du mode programmation. |
| derog\_mode | Enum (0-3) | écriture | Bascule entre les différentes dérogations. 0 : pas de dérogation 1 : mode vacances 2 : mode boost 3 : détection de presence |
...
| window\_switch | Bool (0-1) | écriture | Activation de la détection de fenêtre ouverte. |
| cur\_temp | Int (0-65535) | lecture seule | Température de la pièce, lue par le capteur du Pilote Pro. La température est exprimée en dixièmes de degrés. |
| cft\_temp | Int (0-65535) | écriture | Consigne de température du mode confort. La température est exprimée en dixièmes de degrés. Plage de réglage : 15-30°C |
| eco\_temp | Int (0-65535) | écriture | Consigne de température du mode éco. La température est exprimée en dixièmes de degrés. Plage de réglage : 10-19°C |
| temp\_set\_step | Bool (0-1) | écriture | Fonction liée à l’interface physique du Pilote Pro. Le pas de réglage bascule entre 1°C et 0,5°C |
...
| cur\_humi | Int (0-100) | lecture seule | Taux d’humidité de l’air dans la pièce (%). |
